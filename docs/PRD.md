...
| 2026-08-05 | **static gate ไม่พอ ต้องรันจริง** | การรัน stacked ครั้งแรกบนฮาร์ดแวร์เจอบั๊ก 3 ตัวที่ gate ทั้ง 10 ด่าน **ที่มีอยู่ตอนนั้น** จับไม่ได้ (ปัจจุบัน 13 ด่าน) เพราะทั้งหมดเป็น bash ที่ syntax ถูกต้อง (head container ไม่เคย start, Jinja หลุดเข้าไฟล์ผลลัพธ์, ล็อก image ใช้ร่วมทั้งเครื่อง) · เพิ่ม gate `template-rendered` และยึดหลักว่า **สถานะ hardware-validated ต้องมาจากการรันจริงเท่านั้น** |
