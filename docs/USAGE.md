...
> **ขั้น Docker/NVIDIA toolkit ถูกข้ามเสมอ** — ต้องใช้ `sudo` ซึ่งหน้าเว็บไม่มี tty ให้กรอกรหัสผ่าน
> เครื่องที่ยังไม่มี Docker ต้องไปรัน `./install.sh` บนเครื่องนั้นเอง
