...
LMDS จึงเก็บทั้ง **สูตรที่รันผ่านจริงบนฮาร์ดแวร์แล้ว** และ parser hint ที่ตรวจที่มาไว้ในตัวโปรแกรม:
...
- รายการ `settings-only` ไม่ได้แปลว่า bundle พร้อมรัน: LMDS แสดงคำเตือน, เติมเฉพาะ parser
  ที่ยังว่าง และไม่อ้างว่า runtime-validated จนกว่า image/patch/template/plugin จะรองรับครบ
