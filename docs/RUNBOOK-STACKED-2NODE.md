...
| `--gpu-util` | RAM ที่ระบบใช้ (steady) | เหลือว่าง | KV cache | `test-text` |
|---|---|---|---|---|
| 0.85 (ค่าตั้งต้น) | 109 GB จาก 121 GB | 11 GB | 221,056 tokens | ผ่าน |
| **0.80 (แนะนำ)** | **103 GB** | **17–19 GB** | **184,080 tokens** | ผ่าน |

(วัดจริงบน DGX Spark 2 เครื่อง 5 ส.ค. 2569 · Llama 3.3 70B · context 65,536)

ค่าที่เห็นตอนพีคจะสูงกว่า steady ราว 8 GB เพราะช่วง warm-up/CUDA graph capture — ที่ 0.85
พีคแตะ 117–118 GB จาก 121 GB ซึ่งบางเกินไปเมื่องานอื่นบนเครื่อง (docker, page cache, rsync)
เบียดเข้ามา · 0.80 จึงเป็นจุดที่คุ้มกว่า: เสีย KV ไป 17% แต่ได้ที่ว่างเพิ่มเกือบเท่าตัว
