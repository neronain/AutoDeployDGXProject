...
and `nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-NVFP4` on 2× DGX Spark · **24 target presets** (7 verified on
real hardware) · **2,311 tests** (`pytest --collect-only` at 0.10.0, 2026-09-21 — same number as the badge)
