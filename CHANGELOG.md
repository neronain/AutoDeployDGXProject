...
- **`install.sh` ตรวจความพร้อมเครื่องและถามตั้งค่าให้** — driver / Docker / Docker เห็น GPU /
  ดิสก์ว่าง แล้วถามเลือก LLM provider + API key + tab completion (ข้ามได้ทุกขั้น, ไม่ถามเมื่อไม่ใช่ tty)
