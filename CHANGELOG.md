...
- **`lmds list` เห็น bundle ที่เพิ่ง deploy ทันที ไม่ต้องรอ start ครั้งแรก** — เดิม controller เขียน
  ทะเบียนเองตอน `start` เท่านั้น bundle ที่เพิ่งสร้างจึงหายไปจากรายการ ผู้ใช้ไม่รู้ว่าต้องไปต่อยังไง
  (เจอจากการใช้หน้าเว็บจริง) · `register_bundle()` ลงทะเบียนตั้งแต่ตอน generate ทั้ง CLI และเว็บ
  · ไม่เขียนทับทะเบียนของ controller ที่ start แล้ว
